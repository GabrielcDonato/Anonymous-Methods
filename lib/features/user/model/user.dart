...
class User {
  ...
  bool operator ==(Object other) {
    ...
    return other is User && other.name == name && other.picture == picture && other.bornDate == bornDate && other.status == status;
  }

  @override
  int get hashCode {
    return name.hashCode ^ picture.hashCode ^ bornDate.hashCode ^ status.hashCode;
  }
}
